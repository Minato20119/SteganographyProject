 ...
 * @author Minato
 */
public class TrichXuat extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrichXuat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
