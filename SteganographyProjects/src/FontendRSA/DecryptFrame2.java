...
import BackendRSA.ReceiveSite2;
 ...
 * @author Minato
 */
public class DecryptFrame2 extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public DecryptFrame2() {
        initComponents();
    }
    ...
    private void buttonDecryptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDecryptActionPerformed
        ...
        if (!privateKey.getText().equals("") && !pathStegoImage.getText().equals("")) {
            ...
            BufferedImage image = ReceiveSite2.inputImage(pathStegoImage.getText());
            
            List<String> keys = ReceiveSite2.getBinaryFromRGB(image);
            keyK1.setText(keys.get(0));
            keyK2.setText(keys.get(1));
            lengthMessage.setText(keys.get(2));

            String textEncrypted = ReceiveSite2.convertBinaryCipherTextToCipherText(image);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DecryptFrame2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new DecryptFrame2().setVisible(true);
        });
    }
