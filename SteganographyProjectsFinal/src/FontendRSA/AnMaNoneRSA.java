 ...
 * @author Minato
 */
public class AnMaNoneRSA extends javax.swing.JFrame {
    ...
    private void buttonOpenImageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonOpenImageActionPerformed
        ...
        if (!"".equals(pathOpenImage.getText())) {
            try {
                ...
                Logger.getLogger(AnMaNoneRSA.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
...
//            }
            ...
            String textBinary = SentSite.convertTextToBinary(plainText.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnMaNoneRSA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new AnMaNoneRSA().setVisible(true);
        });
    }
